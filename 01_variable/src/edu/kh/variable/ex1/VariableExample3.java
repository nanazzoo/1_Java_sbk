...
//			(단, 띄어쓰기 X)
	...
	//					Num1 변수가 중복이다 (에러)
			...
			int abcdefg;
			int showMeTheMoney;
			int abcwqeqweqweqweqwewqeqwewedefg; //길이 제한 X
			
			
//		2. 예약어를 사용 금지
//			int int;
//			int true; Syntax error on token "true", invalid VariableDeclarator
//			boolean final;
...
//		변수 선언과 동시에 초기화
			...
			System.out.println(age + 10 + name); 	//숫자 + 숫자 + 문자열 = 숫자의 합 + 이어쓰기
			System.out.println(name + age + 10); 	//문자열 + 숫자 + 숫자 = 이어쓰기
													//왼->오 순서대로 더하기 (신보경30+10)
...
//				final : 마지막으로 값을 대입하는 변수 = 다시는 값을 대입 받지 않겠다
//				=변하지 않는 수(상수)
...
//				The final local variable CONSTANT_NUMBER cannot be assigned. 
